        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Books_Languages_OriginalLanguageCode",
                        column: x => x.OriginalLanguageCode,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Movies_MovieSeries_SeriesId",
                        column: x => x.SeriesId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CountryTvSeries", x => new { x.CountriesCode, x.TvSeriesId });
                    table.ForeignKey(
                        name: "FK_CountryTvSeries_Countries_CountriesCode",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DirectorTvSeries", x => new { x.DirectorsId, x.TvSeriesId });
                    table.ForeignKey(
                        name: "FK_DirectorTvSeries_Directors_DirectorsId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TvSeriesVideoGenre", x => new { x.GenresId, x.TvSeriesId });
                    table.ForeignKey(
                        name: "FK_TvSeriesVideoGenre_TvSeries_TvSeriesId",
                        column: x => x.TvSeriesId,
                        principalTable: "TvSeries",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TvSeriesVideoGenre_VideoGenres_GenresId",
                        column: x => x.GenresId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BookLiteratureGenre", x => new { x.BooksId, x.GenresId });
                    table.ForeignKey(
                        name: "FK_BookLiteratureGenre_Books_BooksId",
                        column: x => x.BooksId,
                        principalTable: "Books",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BookLiteratureGenre_LiteratureGenres_GenresId",
                        column: x => x.GenresId,
                        principalTable: "LiteratureGenres",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CountryMovie", x => new { x.CountriesCode, x.MovieId });
                    table.ForeignKey(
                        name: "FK_CountryMovie_Countries_CountriesCode",
                        column: x => x.CountriesCode,
                        principalTable: "Countries",
                        principalColumn: "Code",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MovieVideoGenre", x => new { x.GenresId, x.MoviesId });
                    table.ForeignKey(
                        name: "FK_MovieVideoGenre_Movies_MoviesId",
                        column: x => x.MoviesId,
                        principalTable: "Movies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MovieVideoGenre_VideoGenres_GenresId",
                        column: x => x.GenresId,
                        principalTable: "VideoGenres",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BookLiteratureGenre_GenresId",
                table: "BookLiteratureGenre",
                column: "GenresId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Books_OriginalLanguageCode",
                table: "Books",
                column: "OriginalLanguageCode");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MovieVideoGenre_MoviesId",
                table: "MovieVideoGenre",
                column: "MoviesId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TvSeriesVideoGenre_TvSeriesId",
                table: "TvSeriesVideoGenre",
                column: "TvSeriesId");
        }
