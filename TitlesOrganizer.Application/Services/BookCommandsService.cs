...
namespace TitlesOrganizer.Application.Services
{
    public class BookCommandsService : IBookCommandsService
    {
        ...
        public BookCommandsService(IBookCommandsRepository bookCommandsRepository, IBookModuleQueriesRepository bookModuleQueriesRepository, ILanguageRepository languageRepository, IMapper mapper)
        {
