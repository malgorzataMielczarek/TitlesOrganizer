...
namespace TitlesOrganizer.Tests.Book.ViewModels
{
    public static class Helpers
    {
        public static List<Domain.Models.Book> GetBooksList(int count)
        {
        ...
        public static Domain.Models.Book GetBook(int index = 1)
        {
