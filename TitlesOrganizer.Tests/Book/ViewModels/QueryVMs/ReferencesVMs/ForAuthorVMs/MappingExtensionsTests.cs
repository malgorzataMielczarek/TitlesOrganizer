...
namespace TitlesOrganizer.Tests.Book.ViewModels.QueryVMs.ReferencesVMs.ForAuthorVMs
{
    public class MappingExtensionsTests
    {
        ...
        private IQueryable<Domain.Models.Book> GetBooksWithAuthors()
        {
            ...
            {
                new Domain.Models.Book(){ Id = 1, Title = "Title", Authors = new List<Author>() { author1 } },
                new Domain.Models.Book(){ Id = 2, Title = "Example", Authors = new List<Author>() { author2 } },
                new Domain.Models.Book(){ Id = 3, Title = "Test", Authors = new List<Author>() { author1, author2 } },
                new Domain.Models.Book(){ Id = 4, Title = "Another Title", Authors = new List<Author>() { author1, author2 } }
            }.AsQueryable();
        }
    }
}