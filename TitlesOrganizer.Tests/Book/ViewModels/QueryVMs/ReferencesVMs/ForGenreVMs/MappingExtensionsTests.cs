...
namespace TitlesOrganizer.Tests.Book.ViewModels.QueryVMs.ReferencesVMs.ForGenreVMs
{
    public class MappingExtensionsTests
    {
        ...
        private IQueryable<Domain.Models.Book> GetBooksWithGenres()
        {
            ...
            {
                new Domain.Models.Book(){ Id = 1, Title = "Title", Genres = new List<LiteratureGenre>() { genre1 } },
                new Domain.Models.Book(){ Id = 2, Title = "Example", Genres = new List<LiteratureGenre>() { genre2 } },
                new Domain.Models.Book(){ Id = 3, Title = "Test", Genres = new List < LiteratureGenre >() { genre1, genre2 } },
                new Domain.Models.Book(){ Id = 4, Title = "Another Title", Genres = new List < LiteratureGenre >() { genre1, genre2 } }
            }.AsQueryable();
        }
    }
}