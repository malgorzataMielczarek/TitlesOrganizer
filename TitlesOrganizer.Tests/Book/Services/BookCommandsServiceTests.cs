...
namespace TitlesOrganizer.Tests.Book.Services
{
    public class BookCommandsServiceTests
    {
        ...
        {
            Domain.Models.Book book = new Domain.Models.Book() { Id = 1, Title = "Title" };
            var repositoryMock = new Mock<IBookCommandsRepository>();
        ...
        public void DeleteBook_NotExistingBookId()
        {
            Domain.Models.Book book = new Domain.Models.Book() { Id = 1, Title = "Title" };
            var repositoryMock = new Mock<IBookCommandsRepository>();
            repositoryMock.Setup(r => r.GetBook(book.Id)).Returns((Domain.Models.Book?)null);
            repositoryMock.Setup(r => r.Delete(book));
            IMapper mapper = new Mock<IMapper>().Object;
        ...
        public void SelectAuthorsForBook_NotExistingBookIdAndAuthorsIds()
        {
            ...
            var repositoryMock = new Mock<IBookCommandsRepository>();
            repositoryMock.Setup(r => r.GetBook(bookId)).Returns((Domain.Models.Book?)null);
            repositoryMock.Setup(r => r.GetAuthor(author.Id)).Returns(author);
            repositoryMock.Setup(r => r.UpdateBookAuthorsRelation(It.IsAny<Domain.Models.Book>()));
            IMapper mapper = new Mock<IMapper>().Object;
            ...
            repositoryMock.Verify(r => r.GetAuthor(It.IsAny<int>()), Times.Never());
            repositoryMock.Verify(r => r.UpdateBookAuthorsRelation(It.IsAny<Domain.Models.Book>()), Times.Never());
            repositoryMock.VerifyNoOtherCalls();
        }
        ...
        {
            var book1 = new Domain.Models.Book() { Id = 1, Title = "Title1" };
            var book2 = new Domain.Models.Book() { Id = 2, Title = "Title2" };
            var book3 = new Domain.Models.Book() { Id = 3, Title = "Title3" };
            var author = new Author()
            {
                Id = 1,
                Books = new List<Domain.Models.Book>() { book1 }
            };
        ...
        public void SelectBooksForAuthor_ExistingAuthorIdAndNotExistingBooksIds()
        {
            ...
            var repositoryMock = new Mock<IBookCommandsRepository>();
            repositoryMock.Setup(r => r.GetAuthor(author.Id)).Returns(author);
            repositoryMock.Setup(r => r.GetBook(2)).Returns((Domain.Models.Book?)null);
            repositoryMock.Setup(r => r.GetBook(3)).Returns((Domain.Models.Book?)null);
            repositoryMock.Setup(r => r.UpdateAuthorBooksRelation(author));
            IMapper mapper = new Mock<IMapper>().Object;
        ...
        public void SelectGenresForBook_NotExistingBookIdAndLiteratureGenresIds()
        {
            ...
            repositoryMock.Setup(r => r.UpdateBookGenresRelation(It.IsAny<Domain.Models.Book>()));
            IMapper mapper = new Mock<IMapper>().Object;
            ...
            repositoryMock.Verify(r => r.UpdateBookGenresRelation(It.IsAny<Domain.Models.Book>()), Times.Never());
            repositoryMock.VerifyNoOtherCalls();
        }
        ...
        public void SelectSeriesForBook_NotExistingBookIdAndBookSeriesId()
        {
            ...
            repositoryMock.Setup(r => r.UpdateBookSeriesRelation(It.IsAny<Domain.Models.Book>()));
            IMapper mapper = new Mock<IMapper>().Object;
            ...
            repositoryMock.Verify(r => r.UpdateBookSeriesRelation(It.IsAny<Domain.Models.Book>()), Times.Never());
            repositoryMock.VerifyNoOtherCalls();
        }
